...
* Playtest en el proyecto

Es *necesario y obligatorio* hacer un proceso de playtest en el proyecto.
...
- ¿Cómo se ha aplicado la información de playtest al proyecto?
